<template>
	<view>
		...
		<view class="wapper"><image @click="handleUpload" class="avatar" :src="path || `/static/headimg-${user.gender ? 'male' : 'female'}.svg`" mode="aspectFit"></image></view>
	</view>
</template>
